import { getTeachersNatural } from "@api/public";
import Button from "@components-ui/Button";
import InputField from "@components-ui/Input";
import useSearchFilter from "@hooks/useSearchFilter";
import React, { useEffect } from "react";

const TeachersNaturalSearch = ({ onResults, onUserAction }) => {
  const {
    form,
    handleChange,
    handleResetFilter,
    ...
    searchType: "teacher",
    fetchFunction: getTeachersNatural,
  });
...
export default TeachersNaturalSearch;
