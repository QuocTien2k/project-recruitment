import { listReportResolved } from "@api/report";
import Button from "@components-ui/Button";
import InputField from "@components-ui/Input";
import useSearchFilter from "@hooks/useSearchFilter";
import React, { useEffect } from "react";

const ResolvedReportSearch = ({ onResults, onUserAction }) => {
  const { form, handleChange, handleResetFilter, results } = useSearchFilter({
    searchType: "admin-report",
    fetchFunction: listReportResolved,
  });
...
export default ResolvedReportSearch;
